...
/// or the directory in which the executable resides otherwise, traversing
/// symlinks if necessary.
///
/// The algorithm used is:
///
/// * If the `CARGO_MANIFEST_DIR` environment variable is defined it is used as
///   application root. This simplifies running development projects through
///   `cargo run`. See the [cargo reference documentation][cargo-ref] for more
///   details.
/// * If the executable name can be found using [`std::env::current_exe`],
///   resolve all symlinks and use the directory it resides in as application
///   root.
///
...
// application_dir
////////////////////////////////////////////////////////////////////////////////
/// Same as [`application_root_dir`], but extends the root directory with the
/// given path.
///
/// [`application_root_dir`]: fn.application_root_dir.html
#[inline]
